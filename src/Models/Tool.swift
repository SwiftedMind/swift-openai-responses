...
@Codable @CodedAt("type") @CodingKeys(.snake_case) public enum Tool: Equatable, Hashable, Sendable {
  ...
  public struct Function: Equatable, Hashable, Codable, Sendable {
    ...
    public enum Parameters: Codable, Sendable {
      case jsonSchema(JSONSchema)
      case generationSchema(GenerationSchema)
      ...
      public init(from decoder: Decoder) throws {
        ...
        let generationSchema = try GenerationSchema(from: decoder)
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case let .generationSchema(generationSchema):
          try generationSchema.encode(to: encoder)
        }
      }
    }
    ...
    public init(name: String, description: String? = nil, parameters: GenerationSchema, strict: Bool = true) {
      self.init(name: name, description: description, parameters: .generationSchema(parameters), strict: strict)
    }
    
    public static func == (lhs: Tool.Function, rhs: Tool.Function) -> Bool {
      lhs.name == rhs.name && lhs.description == rhs.description && lhs.strict == rhs.strict
    }
...
public extension Tool {
  ...
  /// - Parameter strict: Whether to enforce strict parameter validation.
  static func function(name: String, description: String? = nil, parameters: GenerationSchema, strict: Bool = true) -> Self {
    .function(Function(name: name, description: description, parameters: parameters, strict: strict))
  }
